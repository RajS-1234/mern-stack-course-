...
// console.log(arr2);
// console.log(arr);
// // // splice(start,end,new Element) change org arr
// const arr3=arr.splice(1,3,"rajneesh","jhrf");
// console.log(arr3);
// console.log(arr);
...
// // How to concat more then two arr
...
// const names = ["Alice", "raj","Bob","Mohit", "Charlie","Bob"];
